...
class GeneralTests(TestCase):
    def test_serving_static_files(self):
        ...
        result = finders.find('images/bunnyanddino.jpg')
...
class IndexPageTests(TestCase):
    ...
    def test_rango_picture_displayed(self):
        ...
        # Chapter 4
        response = self.client.get(reverse('index'))
        self.assertIn(b'img src="/static/images/bunnyanddino.jpg', response.content)
...
class AboutPageTests(TestCase):
    ...
    def test_about_contains_create_message(self):
        ...
        self.assertIn(b'Copyright Peaches K. Winchester 2016', response.content)
...
class Chapter4ViewTests(TestCase):
    def test_index_contains_hello_message(self):
        ...
        response = self.client.get(reverse('index'))
        self.assertIn('Peaches says...', response.content)
    ...
    def test_about_contains_create_message(self):
        ...
        response = self.client.get(reverse('about'))
        self.assertIn('Copyright Peaches K. Winchester 2016', response.content)
